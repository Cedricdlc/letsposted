...
**Langue du contenu — test en cours (depuis le 2026-07-23)** : après plusieurs allers-retours (francophone → anglais → ce nouveau test), je repasse le contenu X en français à l'essai pour une semaine, jusqu'au 30/07, avant de trancher définitivement. Raison : l'anglais me met une distance, la voix sonne moins naturelle qu'en français — et toute cette stratégie de contenu repose sur le principe que la voix ne doit jamais sonner forcée. Le produit et la landing (`letsgetposted.com`) restent en anglais, inchangés — le switch ne concerne que le contenu X (TOFU/MOFU/BOFU), pas le produit. Les ~30 posts déjà rédigés en anglais dans `docs/launch-plan.md` et la base Notion "Contenu" ne sont pas retraduits rétroactivement ; seuls les nouveaux posts (à partir du 23/07) sont rédigés en français pendant l'essai. Si ça revient en question après le 30/07 : décider si on continue en français, si on repasse en anglais, ou si on retraduit le passé — ne rien supposer, redemander.
